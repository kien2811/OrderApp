...
public class Api {
    public static final  String HOST = "192.168.1.3:8888/oder_cart_php/public";
    ...
    public static final  String URl_CHECK_ADDRESS = "http://"+HOST+"/?controller=index&action=check_address";
