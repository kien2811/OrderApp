...
public class DaHuyAdapter extends RecyclerView.Adapter<DaHuyAdapter.ViewHolder> {
    DaHuyFragment context;
    int layout;
    List<DonHang> list;

    public DaHuyAdapter(DaHuyFragment context, int layout, List<DonHang> list) {
