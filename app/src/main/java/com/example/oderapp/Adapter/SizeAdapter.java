...
public class SizeAdapter extends RecyclerView.Adapter<SizeAdapter.ViewHolder> {
    ...
    public SizeAdapter(DetailCartActivity context, int layout, List<SizeItem> list) {
...
//                    Toast.makeText(context, ""+sizeItem.getQuantity(), Toast.LENGTH_SHORT).show();
                    context.AddMuaNgay(sizeItem.getQuantity(),sizeItem.getId());
                }
            });
            // set color
