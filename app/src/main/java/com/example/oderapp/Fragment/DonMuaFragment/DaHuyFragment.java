...
public class DaHuyFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    RecyclerView recyclerViewProductAllSanPham;
    SwipeRefreshLayout SwipeRefreshLayout_all_product;
    DaHuyAdapter daHuyAdapter;
    List<DonHang> list;
    ...
    private void data_all() {
        list = new ArrayList<>();
        daHuyAdapter = new DaHuyAdapter(this,R.layout.line_product_da_huy,list);
        ...
        recyclerViewProductAllSanPham.setAdapter(daHuyAdapter);
        sessionManagement = new SessionManagement(getContext());
        int id_user = sessionManagement.getIduser();
        JsonArrayRequest arrayRequest = new JsonArrayRequest(Request.Method.GET, Api.URL_DON_MUA_DA_HUY+id_user, null, new Response.Listener<JSONArray>() {
            @Override
